	...
	<main>
		<div class="container w-50 shadow rounded-3 mt-4 mb-4">
			...
			<form class="validation-form" action="registration_ok.jsp"
				...
				<input class="form-control mb-3" name="title" placeholder="글 제목">
				<textarea class="form-control mb-3" rows="5"
					placeholder="서울특별시에(내 거주지역표시) 올릴 게시글 내용을 작성해주세요." name="content"></textarea>
				<div class="row">
					<div class="col-3">
						<label style="background-color: #F0E68C;" class="file-label btn" for="input_imgs">사진선택</label>
						<input style="display:none;" id="input_imgs" type="file" multiple>
					</div>
					<div class="col-9" id="imgs-wrap">
						<img id="img" />
					</div>
				</div>
			</form>
